        ...
        forsn(j, 1, 10)
        {
            ...
            forsn(k, 1, 10)
            {
                ...
                forsn(l, 1, 10)
                {
                    ...
                    res[1][0] = k;
                    res[1][1] = l;
                    if (res[0][0] + res[0][1] == m[0][0] &&
                        res[1][0] + res[1][1] == m[0][1] &&
                        res[0][0] + res[1][0] == m[1][0] &&
                        res[0][1] + res[1][1] == m[1][1] &&
                        res[0][0] + res[1][1] == m[2][0] &&
                        res[0][1] + res[1][0] == m[2][1])
                    {
                        println(res);
                        return 0;
                    }
