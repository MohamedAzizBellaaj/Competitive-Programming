...
#define tt ll _t; cin>>_t; while(_t--)
...
template<typename T>
ostream& operator<<(ostream& os, set<T>& intermediate_array) { for (auto& a : intermediate_array) cout << a << " "; return os; }

template<typename T>
void print(T a) { cout << a << ln; }
