...
int main()
{
    ...
    forn(i, n)
    {
        if (i == 0)
        {
            tmp = min(abs(v.front() - v.back()), abs(v[i] - v[i + 1]));
            if (tmp < mn)
            {
                if (abs(v.front() - v.back()) < abs(v[i] - v[i + 1]))
                {
                    p = {1, n};
                }
                else
        ...
        {
            tmp = min(abs(v.front() - v.back()), abs(v[n - 1] - v[n - 2]));
            if (tmp < mn)
            {
                if (abs(v.front() - v.back()) < abs(v[n - 1] - v[n - 2]))
                {
                    p = {1, n};
                }
                else
        ...
        {
            tmp = min(abs(v[i] - v[i - 1]), abs(v[i] - v[i + 1]));
            if (tmp < mn)
            {
