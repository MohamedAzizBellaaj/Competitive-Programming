...
template <typename T>
istream &operator>>(istream &is, pair<T, T> &pair)
{
...
template <typename T>
ostream &operator<<(ostream &os, pair<T, T> &pair)
{
...
int main()
{
    ...
    forn(i, n)
    {
        p32 rectangle1ll, rectangle1ur, rectangle2ll, rectangle2ur;
        cin >> rectangle1ll >> rectangle1ur >> rectangle2ll >> rectangle2ur;
        if (i > 0)
        {
            println();
        }
        int max_xll = max(rectangle1ll.fi, rectangle2ll.fi);
        int max_yll = max(rectangle1ll.se, rectangle2ll.se);
        int min_xur = min(rectangle1ur.fi, rectangle2ur.fi);
        int min_yur = min(rectangle1ur.se, rectangle2ur.se);
        if (max_xll < min_xur && max_yll < min_yur)
        {
            cout << max_xll << " " << max_yll << " " << min_xur << " " << min_yur << "\n";
        }
        else
        {
            println("No Overlap");
